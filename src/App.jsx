...
function App() {
  const emojis = [
    ...
    { name: "poo", number: "02", title: "You're a Pile of 💩", content: ["hi"], subtitle: "Google pays attention emojis when expanding to global markets"  },
    ...
    { name: "pistol", number: "04", title: "What a 💣🐚! 😂", content: ["hi"], subtitle: "And with that, each additional emoji invited questions"  },
    { name: "bee", number: "05", title: "Becky! Leave Queen 🐝 Alone 🍋", content: ["hi"] },
    { name: "thumbsup", number: "06", title: "👍 (I'll see you in court)", content: ["Emoji is the language of cute, but it becomes less cute when it results in thousands of dollars leaving your bank account. 👍 made the news when a Canadian farmer Chris Achter responded to a contract confirmation with: 👍. When the buyer sued Achter for failing to deliver, the judge ruled that 👍 was just as good as signature and ordered Achter to cough up $61,442 USD."] },
  ];
